...
export function buildGteCapaActions(): CorrectiveAction[] {
  const rows: CorrectiveAction[] = [
    ...
    action({
      id: "CAPA-001",
      title: "Reemplazar base y relé K4 — CPW01",
      description:
        "Ejecutar correctivo post-detonación según RCA-001 / IP-GTE-001. Verificar cableado de shutoff y checklist de bases de relé.",
      ...
      comments: [
        comment("CAPA-001", 1, "Base y relé K4 reemplazados; sin reincidencias.", "Eléctrico", "2026-07-10"),
      ],
      evidences: [evidence("CAPA-001", 1, "ot_k4_cpw01.pdf", "OT reemplazo K4", "Eléctrico", "2026-07-05")],
    }),
    action({
      id: "CAPA-002",
      title: "Actualizar procedimiento de montaje de escape/admisión",
      description: "Documentar checklist pre-arranque y torque de flexibles (RCA-002 / 05-jun CPW01).",
    ...
    action({
      id: "CAPA-011",
      title: "Contención post-perturbación transitoria CPW03",
      description:
        "Acción inmediata de restablecimiento tras salida por perturbación transitoria (11-jun · FS≈3,92 h). Seguir diagnóstico RCA-008.",
      actionType: "Correctiva",
      origin: "Evento",
