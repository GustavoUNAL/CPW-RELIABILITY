...
export const PROJECT_NAV_TREE: NavModule[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { id: "an-rca-gte", label: "Fichas RCA · Costayaco" },
          { id: "an-rca-casos", label: "Casos y PDF" },
  ...
  },
  {
    key: "mantenimiento",
    label: "Mantenimiento",
    description: "Planes, ejecución, optimización e intervención",
    children: [
      { id: "dash-mto", label: "Resumen" },
  ...
  },
  {
    ...
    description: "Salud de activos e inventario",
    children: [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { id: "inf-conf-maquinas", label: "Desempeño por máquina" },
          { id: "inf-conf-fallas", label: "Análisis de fallas" },
          { id: "inf-conf-repetitivos", label: "Repetitivos y malos actores" },
          { id: "inf-conf-inventario", label: "Mínimos de inventario" },
          { id: "inf-conf-degradacion", label: "Degradación y riesgos" },
          { id: "inf-conf-conclusiones", label: "Conclusiones" },
        ],
      },
    ],
  },
  {
    key: "admin",
    label: "Admin",
    description: "Usuarios, uso de la plataforma y administración",
    children: [
      { id: "admin-usuarios", label: "Usuarios" },
      { id: "admin-uso", label: "Uso y vistas" },
    ],
  },
];
